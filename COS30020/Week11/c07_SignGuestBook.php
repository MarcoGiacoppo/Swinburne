...
<body>
	...
	$DBName = "guestbook";
	if (!@mysqli_select_db($DBConnect, $DBName)) { // Use correct variable: $DBConnect
	
		$SQLstring = "CREATE DATABASE $DBName"; // added quotes
		$QueryResult = @mysqli_query($DBConnect, $SQLstring)
			or die("<p>Unable to execute the query.</p>"
				. "<p>Error code " . mysqli_errno($DBConnect)
				. ": " . mysqli_error($DBConnect) . "</p>"); // wrong ) placement
	...
	mysqli_close($DBConnect); // corrected function
	?>
</body>
